        ...
        <ErrorBoundary>
            <div className="min-h-screen flex flex-col relative selection:bg-purple-500/30">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="fixed bottom-8 right-8 z-[100] group transition-transform hover:scale-110"
                    aria-label="Chat on WhatsApp"
                >
                    <div className="relative w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl">
                        <svg 
                            viewBox="0 0 24 24" 
